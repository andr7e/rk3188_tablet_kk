...
#if defined(CONFIG_MACH_RK3188_RADXA_ROCK) || defined(CONFIG_MACH_RK3188_PMP5785) || defined(CONFIG_MACH_RK3188_PMP5101)
	#define RK3066B_HOST_DRV_VBUS RK30_PIN0_PA3
#else
	#define RK3066B_HOST_DRV_VBUS RK30_PIN0_PC0
#endif

#if defined(CONFIG_MACH_RK3188_PMP5785) || defined(CONFIG_MACH_RK3188_PMP5101)
